...
// heap_str
//============================================================================
PFC_INTROSPEC_INL_DEF(heap_str)
{
  ...
  switch(unsigned(PE::pe_type))
  {
    ...
    case penum_display:
    {
      ...
      PFC_CHECK_MSG(m_size<=0xffffffff, ("Unable to serialize heap_string that contains more than 2^32-1 characters\r\n"));
...
// stack_str
//============================================================================
PFC_INTROSPEC_INL_TDEF1(unsigned cap, stack_str<cap>)
{
  PFC_CUSTOM_STREAMING(0);
  switch(unsigned(PE::pe_type))
  {
