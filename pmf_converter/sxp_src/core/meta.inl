...
namespace priv
{
  ...
  template<> struct is_type_fund_hlp<const volatile int64>           {enum {res=true};};
  template<> struct is_type_fund_hlp<const volatile uint64>          {enum {res=true};};
...
namespace priv
{
  ...
  template<> struct is_type_int_hlp<const volatile int64>           {enum {res=true};};
  template<> struct is_type_int_hlp<const volatile uint64>          {enum {res=true};};
} // namespace priv
//----
...
namespace priv
{
  ...
  template<> struct is_type_signed_hlp<const volatile int64>         {enum {res=true};};
...
namespace priv
{
  ...
  template<> struct is_type_unsigned_hlp<const volatile uint64>          {enum {res=true};};
} // namespace priv
//----
...
// is_type_introspec
//============================================================================
template<typename T> char has_class_introspection(has_class_trait<const volatile T>); // not implemented
template<typename T>
struct is_type_introspec
{
  enum {res=1!=sizeof(has_class_introspection(has_class_trait<const volatile T>()))};
};
//----

template<typename T>
struct is_type_introspec<T&>
{
  enum {res=false};
};
//----------------------------------------------------------------------------
...
// is_type_crep
//============================================================================
template<typename T> char has_class_repository(has_class_trait<const volatile T>); // not implemented
template<typename T>
struct is_type_crep
{
  enum {res=1!=sizeof(has_class_repository(has_class_trait<const volatile T>()))};
};
//----

template<typename T>
struct is_type_crep<T&>
{
  enum {res=false};
};
//----------------------------------------------------------------------------
...
namespace priv
{
  ...
  struct is_type_orep_hlp
  {
    enum {res=   1!=sizeof(has_object_repository(has_class_trait<const volatile T>()))
              || is_type_orep_hlp<typename T::parent_class_t, is_type_introspec<typename T::parent_class_t>::res>::res};
  };
  template<typename T> struct is_type_orep_hlp<T, false> {enum {res=false};};
  template<> struct is_type_orep_hlp<void, false> {enum {res=false};};
} // namespace priv
//----------------------------------------------------------------------------

template<typename T> char has_object_repository(has_class_trait<const volatile T>); // not implemented
template<typename T>
struct is_type_orep
{
  enum {res=priv::is_type_orep_hlp<T, 1!=sizeof(has_class_repository(has_class_trait<const volatile T>()))>::res};
};
//----

template<typename T>
struct is_type_orep<T&>
{
  enum {res=false};
};
//----------------------------------------------------------------------------
...
{
  template<typename T, bool>
  struct is_type_var_csig_hlp
  {
    enum {res=   1!=sizeof(has_variable_class_signature(has_class_trait<const volatile T>()))
              || is_type_var_csig_hlp<typename T::parent_class_t, is_type_introspec<typename T::parent_class_t>::res>::res};
  };
  template<typename T> struct is_type_var_csig_hlp<T, false> {enum {res=false};};
  template<> struct is_type_var_csig_hlp<void, false> {enum {res=false};};
} // namespace priv
//----------------------------------------------------------------------------

template<typename T> char has_variable_class_signature(has_class_trait<const volatile T>); // not implemented
template<typename T>
struct is_type_var_csig
{
  enum {res=priv::is_type_var_csig_hlp<T, 1!=sizeof(has_class_introspection(has_class_trait<const volatile T>()))>::res};
};
//----

template<typename T>
struct is_type_var_csig<T&>
{
  enum {res=false};
};
//----------------------------------------------------------------------------
...
template<typename T>
struct is_ptr_introspec
{
  enum {res=is_type_ptr<T>::res && is_type_introspec<typename remove_ptr<T>::res>::res};
};
//----------------------------------------------------------------------------
...
struct is_ptr_crep
{
  enum {res=is_type_ptr<T>::res && is_type_crep<typename remove_ptr<T>::res>::res};
};
//----------------------------------------------------------------------------
...
struct is_ptr_orep
{
  enum {res=is_type_ptr<T>::res && is_type_orep<typename remove_ptr<T>::res>::res};
};
//----------------------------------------------------------------------------

template<typename T>
struct is_ptr_var_csig
{
  enum {res=is_type_ptr<T>::res && is_type_var_csig<typename remove_ptr<T>::res>::res};
};
//----------------------------------------------------------------------------
...
template<typename T>
struct is_ref_introspec
{
  enum {res=is_type_ref<T>::res && is_type_introspec<typename remove_ref<T>::res>::res};
};
//----------------------------------------------------------------------------
...
struct is_ref_crep
{
  enum {res=is_type_ref<T>::res && is_type_crep<typename remove_ref<T>::res>::res};
};
//----------------------------------------------------------------------------
...
struct is_ref_orep
{
  enum {res=is_type_ref<T>::res && is_type_orep<typename remove_ref<T>::res>::res};
};
//----------------------------------------------------------------------------

template<typename T>
struct is_ref_var_csig
{
  enum {res=is_type_ref<T>::res && is_type_var_csig<typename remove_ref<T>::res>::res};
};
//----------------------------------------------------------------------------
...
struct meta_msb
{
  ...
  enum {r0=v|(v>>1), r1=r0|(uint32(r0)>>2), r2=r1|(uint32(r1)>>4),
        r3=r2|(uint32(r2)>>8), r4=r3|(uint32(r3)>>16),
        res=r4&~(uint32(r4)>>1)};
};
//----------------------------------------------------------------------------
...
struct meta_mask<mask_size_, mask_pos_, int64, dw32_idx_>
{
  enum {mask_pos=mask_pos_-dw32_idx_*32};
  static const int64 res=mask_pos<64?(mask_size_<64?(~(uint64(-1)<<(mask_size_<64?mask_size_:0))):0xffffffffffffffff)<<(mask_pos<64?mask_pos:0):0;
};
//----

template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_mask<mask_size_, mask_pos_, uint64, dw32_idx_>
{
  enum {mask_pos=mask_pos_-dw32_idx_*32};
  static const uint64 res=mask_pos<64?(mask_size_<64?(~(uint64(-1)<<(mask_size_<64?mask_size_:0))):0xffffffffffffffff)<<(mask_pos<64?mask_pos:0):0;
};
//----

template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_mask<mask_size_, mask_pos_, uint128, dw32_idx_>
{
  static const uint128 res;
};
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
const uint128 meta_mask<mask_size_, mask_pos_, uint128, dw32_idx_>::res={uint64(uint32(meta_mask<mask_size_, mask_pos_, uint32, dw32_idx_+0>::res))|(uint64(uint32(meta_mask<mask_size_, mask_pos_, uint32, dw32_idx_+1>::res))<<32),
                                                                         uint64(uint32(meta_mask<mask_size_, mask_pos_, uint32, dw32_idx_+2>::res))|(uint64(uint32(meta_mask<mask_size_, mask_pos_, uint32, dw32_idx_+3>::res))<<32)};
//----------------------------------------------------------------------------
...
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_imask<mask_size_, mask_pos_, int64, dw32_idx_>
{
  static const int64 res=~meta_mask<mask_size_, mask_pos_, int64, dw32_idx_>::res;
};
//----

template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_imask<mask_size_, mask_pos_, uint64, dw32_idx_>
{
  static const uint64 res=~meta_mask<mask_size_, mask_pos_, uint64, dw32_idx_>::res;
};
//----

template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_imask<mask_size_, mask_pos_, uint128, dw32_idx_>
{
  static const uint128 res;
};
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
const uint128 meta_imask<mask_size_, mask_pos_, uint128, dw32_idx_>::res={~meta_mask<mask_size_, mask_pos_, uint128, dw32_idx_>::res.lo,
                                                                          ~meta_mask<mask_size_, mask_pos_, uint128, dw32_idx_>::res.hi};
//----------------------------------------------------------------------------
...
template<typename T0, typename T1, typename T2, typename T3, typename T4,
         typename T5, typename T6, typename T7, typename T8, typename T9>
const uint32 meta_type_array<T0, T1, T2, T3 ,T4, T5, T6, T7, T8, T9>::s_ids[]=
{
