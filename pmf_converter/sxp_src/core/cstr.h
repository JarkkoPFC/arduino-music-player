...
usize_t str_to_float64(float64&, const char*);
usize_t str_to_int64(int64&, const char*);
int str_to_scalar64(float64&, int64&, const char*); // returns positive length for float, negative length for int
